...
public class Dip {
    ...
    private static final int BOUND_FOR_STARTS = 9;
    private static final int BOUND_FOR_NUMBERS = 49;
    ...
    public Dip(int[] arrayOfNumbers, int[] arrayOfStarts) {
        ...
        if (NUMBERS == arrayOfNumbers.length && STARTS == arrayOfStarts.length) {
    ...
    public static Dip generateRandomDip() {
        ...
        for (int i = 0; i < NUMBERS; ) {
            int candidate = generator.nextInt(BOUND_FOR_NUMBERS) + 1;
        ...
        for (int i = 0; i < STARTS; ) {
            int candidate = generator.nextInt(BOUND_FOR_STARTS) + 1;
